...
```bash
# Test auth endpoint
curl -X GET "https://quizzplus-edu.preview.emergentagent.com/api/auth/me" \
  -H "Authorization: Bearer YOUR_SESSION_TOKEN"

# Test protected endpoints
curl -X GET "https://quizzplus-edu.preview.emergentagent.com/api/user/profile" \
  -H "Authorization: Bearer YOUR_SESSION_TOKEN"

curl -X GET "https://quizzplus-edu.preview.emergentagent.com/api/themes" \
  -H "Authorization: Bearer YOUR_SESSION_TOKEN"
```
...
await page.context.add_cookies([{
    ...
    "domain": "quizzplus-edu.preview.emergentagent.com",
    "path": "/",
    "httpOnly": true,
    "secure": true,
    "sameSite": "None"
}]);
await page.goto("https://quizzplus-edu.preview.emergentagent.com");
```
