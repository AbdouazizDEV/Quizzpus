...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!response.user.country || response.user.favorite_themes?.length === 0) {
        navigate('/welcome');
      } else {
  ...
  return (
    <div className="min-h-screen bg-[#1B2042] flex flex-col items-center justify-center px-6 py-12" data-testid="login-page">
      <motion.div
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-[#F5EFD9]/70">Bon retour parmi nous !</p>
        </div>
        ...
        <p className="text-center text-[#F5EFD9]/60 mt-6">
          Pas encore inscrit ?{' '}
          <Link to="/signup" className="text-[#C9A84C] font-semibold hover:underline" data-testid="goto-signup-link">
            Créer un compte
          </Link>
        </p>
      </motion.div>
